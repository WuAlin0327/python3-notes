...
#函数进阶：
#1.txt.写函数，返回一个扑克牌列表，里面有52项，每一项是一个元组
# def func():
# 	taem_list = []
# 	lis = []
# 	for i in range(2,11):
...
# 	dic['min'] = min(num)
# 	return dic
# l = (1.txt,2,3,4,5,6,6,4,3,3,54,6,5,4,)
# s = func(l)
# print(s)
